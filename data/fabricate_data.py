        ...
        for i in range(0, end):
            ...
            for attribute in entity_diction.keys():
                ...
                if len(entity_diction[attribute]) == 4:
                    ...
                    if primary == False or entity == 'Timeslot':
                        ...
                        if type == 'text':
                            ...
                            if name == 'Priority':
                                temp_dict[name] = random.random() * 10.0

                        elif type == 'timestamp':
                            temp_dict[name] = str(fake.unique.date_time_between(
                                start_date='now', end_date='+90d'))

                        elif type == 'time':
                            temp_dict[name] = fake.date_time().time()
